...
" Nimo: Make tab characters to appear 4-spaces wide
set tabstop=4
...
" FSwitch
"
  au! BufEnter *.cc let b:fswitchdst = 'h' | let b:fswitchlocs = '../inc'
  au! BufEnter *.h let b:fswitchdst = 'cc, cpp, c' | let b:fswitchlocs = '../inc'



"  youcompleteme fix
  let g:ycm_global_ycm_extra_conf = '/Users/niw/.vim/bundle/YouCompleteMe/third_party/ycmd/cpp/ycm/.ycm_extra_conf.py'
